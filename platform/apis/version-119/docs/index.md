# TIBCO Platform APIs 1.19 - Changelog

This document provides a comprehensive changelog of the TIBCO Platform APIs across all versions, from 1.7 through the current release 1.19. Use the navigation to view detailed changes for each individual API.
