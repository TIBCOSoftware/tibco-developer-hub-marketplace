...
![MCP Trigger Configuration](images/Flogo-flow-MCPTrigger-Config-Prompt.webp)

### Flow Input Mapping
Mapping inputs from Claude (via MCP) to the Flogo flow variables:

![Flow Input Mapping](images/Flogo-flow-MCPTrigger-MapToFlowInputs.webp)
...
![Flow Output Settings](images/Flogo-flow-MCPTrigger-OutputSettings-AsSchemaVarsFromVariablesFromPongoTemplate.webp)

### Flow Output Mapping
Mapping the generated prompt back to Claude via MCP trigger outputs:

![Flow Output Mapping](images/Flogo-Flow-MCPTrigger-MapFromFlow-Outputs.webp)

### Return Prompt Configuration
Final step - returning the dynamically generated prompt to Claude:

![Return Prompt](images/Flogo-Flow-Return-Prompt.webp)
...
![Pongo2 Template Settings](images/Pongo2-activity-Settings-Pongo2template.webp)

### Auto-Generated JSON Schema
The system automatically detects template variables and generates JSON schema for input mapping:

![Auto-Generated Schema](images/Pongo2-activity-InputSetting-JSONSchemaForDetected-Pongo2TemplateVariables.webp)

### Input Variable Mapping
Mapping flow variables to template variables using the auto-generated schema:

![Input Mapping](images/Pongo2-activity-InputMapping.webp)

### Rendered Prompt Output
The final rendered prompt ready to be sent to Claude:

![Rendered Prompt Output](images/Pongo2-activity-Output-renderedPrompt.webp)
...
![Flow Executable](images/Flow-flow-executable-run.webp)

### Flow Invoked by Claude
The flow being actively invoked by Claude through the MCP connection:

![Flow Invoked by Claude](images/Flow-flow-executable-run-invoked-byClaude.webp)
...
![Adding MCP Server](images/Claude-addingPrompt-viaMCP.webp)

### Prompt Available in Claude
The custom prompt now available as a tool in Claude Desktop:

![Prompt Added to Claude](images/Claude-added-prompt-for-travelItinerary.webp)

### Attached Prompt from Flogo
Claude successfully connected to the Flogo MCP server and can access the prompt:

![Attached Prompt](images/Claude-attachedPrompt-from-FlogoMCPServer.webp)
...
![Basic Prompt Details](images/Claude-Asking-basic-prompt-details.webp)

### User Providing Details
User filling in the requested information based on the generated prompt:

![Details Filled](images/Claude-Asking-basic-prompt-details-filled.webp)

### Follow-up Questions
Claude asking for more specific details based on the conditional logic in the prompt:

![More Details Request](images/Claude-asking-more-details-based-OnPrompt-From-Flogo.webp)

### Additional Information
User providing the additional details requested by the intelligent prompt:

![Additional Details Provided](images/Claude-asking-more-details-provided.webp)

### Final Generated Response
Claude generating the final travel itinerary based on the dynamic prompt and user inputs:

![Generated Response](images/Claude-generatedResponse.webp)
