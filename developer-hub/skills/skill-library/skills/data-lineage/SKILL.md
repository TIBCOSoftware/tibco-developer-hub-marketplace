...
The library's `docs/lineage-index.md` and the reports it links (`lineage-materialnumber.md`,
`lineage-inventory-update-msg.md`, `lineage-quantity.md`, `lineage-planned-gi-date.md`) plus
`docs/lineage-data-snapshot.md` are complete worked examples over a `sap-integration-hub` catalog —
