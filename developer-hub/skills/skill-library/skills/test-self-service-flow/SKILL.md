...
Write the script below to `/tmp/test-self-service-dry.mjs`, substituting `TEMPLATE_DIR`,
...
Write `/tmp/run-self-service-flow.mjs` and run with `dangerouslyDisableSandbox: true`:
